...
# The purpose of this code is to measure the time taken to reduce the MNIST dataset
# of hand written digits to various compression levels and train a classifier with
# that corresponing input layer size
