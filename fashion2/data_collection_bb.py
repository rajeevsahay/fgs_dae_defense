...
#Load models
attacker_classifier = load_model('classifiers/fc-784-200-200-100-10-attacker-model.h5')
attack_classifier_adv_trn = load_model('classifiers/fc-784-200-200-100-10-adv-trn-atkr.h5')
defender_classifier = load_model('classifiers/fc-784-100-100-10-defender-model.h5')
...
scores = defender_classifier.evaluate(data_test, labels_test)
...
for idx, eta in enumerate(e):
    ...
    adv_acc = defender_classifier.evaluate(adv_test_x, labels_test)
    ...
    dae_output_acc = defender_classifier.evaluate(decoded_data, labels_test)
...
np.savetxt("retained_acc_bb_sigprocletter_digits.csv", data, delimiter=",")
